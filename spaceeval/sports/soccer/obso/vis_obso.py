...
def plot_frame( hometeam, awayteam, figax=None, team_colors=('r','b'), field_dimen = (106.0,68.0), include_player_velocities=False, include_ball_position=True, Playermarkersize=10, PlayerAlpha=0.7, annotate=False ):
